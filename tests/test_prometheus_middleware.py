...
class TestPrometheusMiddleware:
    ...
    def test_path_normalization(self, mock_app):
        ...
        assert middleware._default_path_normalizer("/posts/456/comments/789") == "/posts/{id}/comments/{id}"
    ...
    @pytest.mark.asyncio
    async def test_successful_request_metrics(self, mock_app, mock_scope, mock_protocol):
