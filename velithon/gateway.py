...
from velithon.responses import JSONResponse, PlainTextResponse, Response
...
class GatewayRoute(BaseRoute):
    ...
    async def openapi(self) -> tuple[dict, dict]:
        ...
        path_spec = {
            "summary": f"Gateway to backend service",
            "description": f"Forwards requests to backend service(s)",
            "tags": ["Gateway"],
            "responses": {
