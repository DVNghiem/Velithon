...
class Protocol:
    ...
    def response_str(self, status: int, headers: typing.Tuple[str, str], body: str) -> None: ...
    def response_bytes(self, status: int, headers: typing.Tuple[str, str], body: bytes) -> None: ...
    def response_file(self, status: int, headers: typing.Tuple[str, str], file:  typing.Any) -> None: ...
    def response_stream(self, status: int, headers: typing.Tuple[str, str]) -> typing.Any: ...
